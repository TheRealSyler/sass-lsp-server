...
`,
  ...
  let foundNode: SassNode = {
    type: 'property',
    value: [{ type: 'variableRef', value: '$var5', ref: null }],
    level: 1,
    line: 10,
  ...
  foundNode = {
    type: 'property',
    value: [{ type: 'variableRef', value: '$test', ref: { line: 17, uri: '/file' } }],
    level: 5,
    line: 22,
  ...
  foundNode = {
    type: 'property',
    value: [{ type: 'literalValue', value: 'block' }],
    level: 3,
    line: 44,
    name: [{ type: 'literalValue', value: 'display' }],
  };
  ...
  foundNode = {
    type: 'property',
    value: [{ type: 'literalValue', value: 'absolute' }],
    level: 3,
    line: 47,
    name: [{ type: 'literalValue', value: 'position' }],
  };
